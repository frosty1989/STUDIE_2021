...
\section{Conclusions and future work of study}

Let us recapitulate the goals of this study from the \hyperref[sec:introduction]{Introduction}:
...
The first goal is described in section \hyperref[sec:setting_up]{Setting up a curve follow project in RoboDK}, the second goal in section \hyperref[sec:modifying]{Modifying the FANUC R--30iA post processor methods}. The third goal has been achieved in section \hyperref[sec:modifying]{Modifying the FANUC R--30iA post processor methods} and finally, the test simulation is demonstrated in chapter

\section{Future work of PhD thesis}
