...
\begin{itemize}
    ...
    \item \mintinline{shell-session}{Settings} -- opens the default settings window \cite{robodksolidworks}.
\end{itemize}
...
A post processor in RoboDK is a Python script (\mintinline{shell-session}{.py} extension). All the RoboDK post processors are located in the
