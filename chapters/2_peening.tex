...
Laser spot sizes used for LSP vary in practice between hundreds of micrometres and \SIrange{6}{10}{\mm}.  The usable laser spot sizes are restricted mainly by the incident laser power density. The main difference between using a laser spot with a small diameter compared to a laser spot with a larger diameter lies in the way the shock waves expand in the material:
...
Consequently, the planar shock wave propagates further into the material, and the residual stresses reach deeper than the spherical shock wave. 

The magnitude of residual stresses usually reaches its maximum at the surface and decreases with depth. This rule is valid for square laser spots. which minimalize instabilities of the residual stresses at the centre of the laser spot. On the other hand, when using a circular laser spot, the residual stresses at the centre of the laser spot are unstable due to the complicated interactions of shock waves in this region. 
...
\begin{itemize}
    ...
    \item laser-induced breakdown of air can occur if the magnitude of the laser power density is too high

    \item when the magnitude of laser power density is higher than a certain threshold, residual stresses increase in depth but decrease at the surface because of surface release waves

    \item another consequence of increasing the laser power density above a certain threshold is the saturation and scattering of the corresponding pressure. The saturation of pressure is caused by the confining overlay breakdown phenomenon. This breakdown limits the magnitude of the laser power density reaching the material.
